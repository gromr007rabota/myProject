...
class CCalculateThreeStepComponent extends Firecode\CalculateComponents
{
    ...
    public function executeComponent()
    {
        ...
        $this->urlApiRequest =  \Firecode\GlobalsIds::CONST_URL_API_REQUEST_STEP_THREE;
        //-----------
        //-----------
    ...
    public function getRequestInProperty()
    {
        ...
        if ($_REQUEST["GEN_FEMALE"] && $_REQUEST["CITY_MALE"]) {
            ...
            $masAllRequest["COLOR_ONE"] = $_REQUEST["COLOR_ONE"];
            $masAllRequest["COLOR_TWO"] = $_REQUEST["COLOR_TWO"];
            $masAllRequest["COLOR_THREE"] = $_REQUEST["COLOR_THREE"];
    ...
    {
        $arResult = [];
        if ($_REQUEST["SUBMIT_CALCULATE_STEP_THREE"] == 'yes') {
